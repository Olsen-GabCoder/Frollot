...
$result = docker exec frollot_mysql mysql -u coiffure_user -p"$env:DB_PASSWORD" coiffure_db -e "
SELECT
    table_name as 'Table',
...
$totalRows = docker exec frollot_mysql mysql -u coiffure_user -p"$env:DB_PASSWORD" coiffure_db -e "
...
$tableCount = docker exec frollot_mysql mysql -u coiffure_user -p"$env:DB_PASSWORD" coiffure_db -e "
