-- ========================================
-- SCRIPT DE NETTOYAGE COMPLET DE LA BASE DE DONNÉES (Version sécurisée)
-- ========================================
...
-- Utilisation de DELETE avec WHERE 1=1 pour éviter les erreurs si les tables sont vides
