...
/**
 * Implémentation JavaScript/Web du sélecteur d'image.
 * 
...
class JsImagePickerLauncher(
    ...
    override fun launch() {
        ...
        println("⚠️ ImagePicker non implémenté sur Web - utiliser l'API File du navigateur")
        onImagePicked(null)
    }
}
...
actual fun rememberImagePicker(onImagePicked: (ByteArray?) -> Unit): ImagePickerLauncher {
    return remember { JsImagePickerLauncher(onImagePicked) }
}
